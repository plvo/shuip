...
<CodeHighlight code={`import { useAppForm, TanstackForm } from '@/hooks/shuip/tsf-context'
    ...
    return (
      <TanstackForm form={form}>
        ...
        <form.AppField name='password'>
          {(field) => (
            <field.InputField label='Password' inputProps={{ type: 'password' }} />
          )}
        </form.AppField>
...
<CodeHighlight code={`import { useFieldContext } from '@/hooks/shuip/tsf-context'
