...
<ItemExamples registryName={'side-dialog'} />
...
<PropTable title='SideDialogContent Props' props={[
  {
...
<PropTable title='SideDialogTrigger Props' props={[
  {
    name: 'asChild',
    type: 'boolean?',
