...
<CodeHighlight code={`<AddressField name="address" placeholder="Enter your address" />`} language='tsx' />
...
<form onSubmit={form.handleSubmit(onSubmit)}>
    <AddressField name="address" placeholder="Enter your address" />
...
<ItemFooter itemName={'address-field'} props={[
  {
    name: 'name',
    type: 'string',
    description: 'Field name in the form (should match your form schema)',
  },
  {
    name: 'label',
    type: 'string?',
